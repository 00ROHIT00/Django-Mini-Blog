...
urlpatterns = [
    ...
    path('blog/blogger/<int:author_id>/update-picture/', views.update_profile_picture, name='update_profile_picture'),
    path('blog/blogger/<int:author_id>/update/', views.update_profile, name='update_profile'),
